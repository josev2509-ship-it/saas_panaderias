...
urlpatterns=[
 ...
 path("reportes/",views.reportes,name="reportes"),path("reportes/empleados.csv",views.reporte_empleados,name="reporte_empleados"),path("empleados/",views.empleados,name="empleados"),path("empleados/nuevo/",views.empleado_form,name="empleado_crear"),path("empleados/<int:pk>/",views.empleado_360,name="empleado_360"),path("empleados/<int:pk>/editar/",views.empleado_form,name="empleado_editar"),path("empleados/<int:pk>/documentos/nuevo/",views.documento_cargar,name="documento_cargar"),path("empleados/<int:pk>/cursos/nuevo/",views.curso_asignar,name="curso_asignar"),
