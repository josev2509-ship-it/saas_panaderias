...
class Command(BaseCommand):
 ...
 def handle(self,*args,**o):
  ...
  emp_q,_=Empleado.objects.update_or_create(empresa=e,codigo="DEMO-RRHH-005",defaults={"nombres":"Persona","apellidos":"Quincenal Demo","identificacion":"DEMO-RRHH-005","puesto":p,"departamento":d,"centro":c,"fecha_ingreso":hoy-timedelta(days=300),"salario":Decimal("50000"),"frecuencia_salario":"MENSUAL","frecuencia_pago":"QUINCENAL","estado":"ACTIVO"})
  ...
  tipo_q,_=TipoNomina.objects.get_or_create(empresa=e,nombre="Quincenal Demo",defaults={"periodicidad":"QUINCENAL"});periodo_q,_=PeriodoNomina.objects.get_or_create(empresa=e,tipo=tipo_q,desde=hoy.replace(day=1),defaults={"hasta":hoy.replace(day=15),"estado":"ABIERTO"});procesar_nomina(empresa=e,periodo=periodo_q)
