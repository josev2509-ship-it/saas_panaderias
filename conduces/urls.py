...
urlpatterns = [
    ...
    path('menu/planificacion/calendarios/analizar/', obtener_vista('subir_analizar_calendario'), name='subir_analizar_calendario'),
    path('menu/planificacion/calendarios/<int:calendario_id>/reanalizar/', obtener_vista('reanalizar_calendario'), name='reanalizar_calendario'),
    ...
    path('menu/planificacion/calendarios/plantilla.xlsx', obtener_vista('descargar_plantilla_calendario_oficial'), name='descargar_plantilla_calendario_oficial'),
    path('menu/planificacion/calendarios/<int:calendario_id>/cargar-fechas/', obtener_vista('cargar_fechas_calendario_oficial'), name='cargar_fechas_calendario_oficial'),
