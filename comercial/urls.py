...
urlpatterns = [
    ...
    path("programacion-comercial/",o2c_views.programacion,name="programacion_comercial"),path("programacion-comercial/<str:vista>/",o2c_views.programacion,name="programacion_comercial_vista"),path("o2c/exportar/<str:tipo>/<str:formato>/",o2c_views.exportar,name="o2c_exportar"),
